      ...
      <div class="wrap">
        <div class="main-row">
          ...
          <div class="card">
            ...
            <h2 class="hero-tagline">Raspberry Pi + ESP32 project.</h2>
            <p class="hero-copy">
              This is our starting point. We will add the project features ourselves as the idea develops.
            </p>
          </div>

          <!--card 2 form-->
          <div class="card">
            <h1>Sign In to IoT Loop</h1>
